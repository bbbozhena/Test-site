            ...
            <div className="job-details">
              ...
              <div className="flex flex-col justify-items-start">
                ...
                <p className=" flex text-start font-sans font-normal text-lg leading-6">
                  Wellstar Medical Group, a physician-led multi-specialty group
                  in Atlanta, Georgia, is currently recruiting for a BC/BE
                  ...
                  replacement, surgical atrial fibrillation ablation,
                  ventricular assist device placement, and extra corporeal
